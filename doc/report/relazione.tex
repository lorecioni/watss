...
\hypersetup{ 
  pdftitle=Relazione Basi di Dati Multimediali,
  pdfauthor=Lorenzo Cioni,
  pdfsubject=Miglioramento sistema di annotazione WATSS con tecniche di Computer Vision
}    
...
\supervisor{Prof. Alberto Del Bimbo} % relatore
